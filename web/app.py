...
def applications_overview():
    ...
    # DEV-ONLY FALLBACK: Auto-select most recent deal for local testing
    # Security: Only enabled in debug mode to prevent production multi-tenant leakage
    if not current_deal_id and app.debug:
        ...
        if latest_deal:
            ...
            flask_session.modified = True
            logger.info(f"[DEV] Auto-selected most recent deal for testing: {current_deal_id}")
